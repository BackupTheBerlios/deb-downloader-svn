...
# - Implementar creació del directori de descàrrega...fet. 
...
sub print_usage() {
	...
	print("Usage \n");
	print("\n");
	print("  " . NAME . " --help | --version | --option=build|download --dd-root=directory --file=filename [--skip-update] --mirror-format [-d|--debug]  \n");
	print("\n");
